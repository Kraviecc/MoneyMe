...
internal class InvestmentContributorsController : BaseController
{
	...
	[ProducesResponseType(401)]
	[ProducesResponseType(403)]
	public async Task<ActionResult> DeleteAsync(Guid investmentComponentId, Guid investmentContributorId)
	{
		await _investmentContributorService.DeleteAsync(investmentComponentId, investmentContributorId);
